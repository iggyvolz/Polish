    ...
    const cls=elements[name]=class extends baseClass{
        static Create(){
            if(!baseTagName){
                ...
                return document.createElement(baseTagName, {is: "polish-"+name});
            }
        }
